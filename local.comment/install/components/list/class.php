...
//\CBitrixComponent::includeComponentClass("local:comment.standard.list");
...
class ListComponent extends CBitrixComponent {
    ...
    protected function getResult() {
        ...
        $filter = [
            ...
            'ACTIVE' => 'Y',
            '=PROPERTY_COMMENTELEMENTID' => $this->arParams["COMMENT_ELEMENT_ID"],
        ];
        $select = [
            'ID',
            //  'NAME',
    ...
    public function onPrepareComponentParams($params) {
        $result = array(
            ...
            'COMMENT_ELEMENT_ID' => $params['COMMENT_ELEMENT_ID'],
